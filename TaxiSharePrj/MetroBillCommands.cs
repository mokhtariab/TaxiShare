...
namespace TaxiSharePrj
{
    ...
    /// </summary>
    public class TaxiSharePrjCommands
    {
        private DocumentCommands _ServiceOnlineCommands = new DocumentCommands();
        public DocumentCommands ServiceOnlineCommands
        {
            get { return _ServiceOnlineCommands; }
            set { _ServiceOnlineCommands = value; }
        }
        private DocumentCommands _RecPayCommands = new DocumentCommands();
        public DocumentCommands RecPayCommands
        {
            get { return _RecPayCommands; }
            set { _RecPayCommands = value; }
        }
        private DocumentCommands _UsersCommands = new DocumentCommands();
        public DocumentCommands UsersCommands
        {
            get { return _UsersCommands; }
            set { _UsersCommands = value; }
        }
