...
namespace TaxiSharePrj
{
    public class Global_Cls
    {
        ...
        static public bool Message_TaxiShare(int Code_Msg, MessageType TypeMsg, bool OK_Cancel, string Str_Msg)
        {
            return Message_TaxiShare(Code_Msg, TypeMsg, OK_Cancel, Str_Msg, "");
        }

        static public bool Message_TaxiShare(int Code_Msg, MessageType TypeMsg, bool OK_Cancel, string Str_Msg, string Str_Error)
        {
            MessageTaxiShare_Frm MSF = new MessageTaxiShare_Frm();

            MSF.label_MsgS.Text = Str_Msg;
            MSF.pictureBox_Error.Visible = (TypeMsg == MessageType.SError); MSF.pictureBox_Error.Top = 15;
            MSF.pictureBox_Warning.Visible = (TypeMsg == MessageType.SWarning); MSF.pictureBox_Warning.Top = 15;
            MSF.pictureBox_Configuration.Visible = (TypeMsg == MessageType.SConfirmation); MSF.pictureBox_Configuration.Top = 15;
            MSF.pictureBox_Information.Visible = (TypeMsg == MessageType.SInformation); MSF.pictureBox_Information.Top = 15;
        ...
        //            if (pm.Count() != 0)
        //            {
        //                Global_Cls.Message_TaxiShare(0, Global_Cls.MessageType.SWarning, false, "شماره موبایل در دفتر تلفن موجود می باشد!");
        //                return 2;
        //            }
        //        }
        ...
        //    catch (Exception ex)
        //    {
        //        Global_Cls.Message_TaxiShare(0, Global_Cls.MessageType.SError, false, "لطفا با کمی فاصله دوباره تایید کنید!", ex.ToString());
        //        return 3;
        //    }
        ...
        static public bool ConnectToInternet()
        {
            ConnectionState Description = 0;
            if (!InternetGetConnectedState(ref Description, 0))
            {
                Global_Cls.Message_TaxiShare(0, Global_Cls.MessageType.SWarning, false, "اتصال به اینترنت برقرار نمی باشد!");
                return false;
            }
            return true;
        }
        ...
        //        return "\\\\" + Global_Cls.ServerName + "\\RentCar";
        //    else
        ...
        static public int GetFinePeriod = 15;

        static public int ExpDayBodyInsu = 30;

        static public int ExpDayCarDuty = 2;

        static public int ExpDayCarEnter = 2;

        static public int ExpDayThirdInsu = 30;

        static public int ExpKMService = 100;



        static public int FreeKillometer = 250;

        static public double FineDay = 0;
        
        static public double FineTime = 0;
        
        static public double FineKillometer = 0;
        
        static public string CityLimit = "تهران";


        static public string ServerName = "LocalHost";//"127.0.0.1";

        static public string ConnectionDef = @"Data Source=" + Global_Cls.ServerName + @"\sqlexpress;Integrated Security=True;User ID=CarRentUser;Password=MkhCarRentUser";
        ...
        static public string ConnectionStr = "Data Source=.;Initial Catalog=TxShareDB;Integrated Security=True";
